...
void main() {
  ...
  /*group("Devolucion", () {
    test("Construir un map a partir de una devolucion", () {
      ...
      json1["prid"] = "123";
      json1["encargadoId"] = "ax1914";
      json1["solicitantesIds"] = ["ax1916", "ax1917", "ax1918"];
      json1["tipoSolicitante"] = 1;
      json1["maquinaId"] = "maquina1";
      json1["prestaPiezas"] = [
        {"pieza1": 5},
        {"pieza2": 5},
        {"pieza3": 5}
      ];
      json1["fecha"] = DateTime(2022, 04, 21, 9, 0, 0).toIso8601String();
      json1["horaInicial"] = DateTime(2022, 04, 21, 10, 0, 0).toIso8601String();
      json1["horaLimite"] = DateTime(2022, 04, 21, 14, 0, 0).toIso8601String();

      Prestamo prestamo = Prestamo.fromJson(json1);
